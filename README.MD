Вот твой красивый Markdown-файл на русском языке, готовый для загрузки на GitHub. Я структурировал его так, чтобы он был понятным, аккуратным и профессиональным, с сохранением всех твоих заметок и примеров кода. Файл организован по темам и урокам, чтобы было удобно читать и использовать.
...
### Урок 15: overflow
- **Свойство**:  управляет тем, как содержимое блока ведёт себя, если оно вылезает за его границы.
