    ...
    <div class="threads-create">
      ...
      <div class="threads-create__form">
        <div class="threads-create__form-inputs">
          <h2>ID Автора</h2>
          <input v-model="authorId" class="threads-create__form__author-input" placeholder="1903" type="text">
  
          <h2>Тема</h2>
          <input v-model="title" class="threads-create__form__thread-input" placeholder="Как какать?" type="text">
        </div>

        <div class="threads-create__form-content">
          <h2>Содержание</h2>
          <textarea v-model="content" placeholder="Меня часто спрашивают: Как какать?..." type="text"></textarea>  
        </div>
